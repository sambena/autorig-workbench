...
def main(argv=None):
    ...
    parser.add_argument("models", nargs="*", default=["all"], help="Model names, comma-separated lists, or 'all'.")
    ...
    print(f"BATCH_START models={models_arg} steps={step_list} auto_tune={args.auto_tune} export={args.export}")
